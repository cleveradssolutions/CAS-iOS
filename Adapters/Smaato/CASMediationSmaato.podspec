Pod::Spec.new do |s|
  ...
  s.source              = { :http => "https://github.com/cleveradssolutions/CAS-iOS/releases/download/4.7.1/CASMediationSmaato-23.1.0.0.zip" }
  s.platform            = :ios, '13.0'
  s.swift_version       = '5.0'
  s.static_framework    = true
  s.vendored_frameworks = 'CASMediationSmaato.xcframework'
  s.dependency 'smaato-ios-sdk', '23.1.0'
  s.dependency 'smaato-ios-sdk/InApp', '23.1.0'
