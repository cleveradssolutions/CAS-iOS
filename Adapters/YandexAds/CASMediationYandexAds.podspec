Pod::Spec.new do |s|
  ...
  s.source              = { :http => "https://github.com/cleveradssolutions/CAS-iOS/releases/download/4.1.2/CASMediationYandexAds-7.14.0.0.zip" }
  s.platform            = :ios, '13.0'
  s.swift_version       = '5.0'
  s.static_framework    = true
  s.vendored_frameworks = 'CASMediationYandexAds.xcframework'
  s.dependency 'YandexMobileAds', '7.14.0'
