Pod::Spec.new do |s|
  ...
  s.source              = { :http => "https://github.com/cleveradssolutions/CAS-iOS/releases/download/4.9.0-alpha2/CASMediationAppLovin-13.6.3.2-alpha49.zip" }
  s.platform            = :ios, '13.0'
  s.swift_version       = '5.0'
