Pod::Spec.new do |s|
  ...
  s.source              = { :http => "https://github.com/cleveradssolutions/CAS-iOS/releases/download/4.7.3/CASMediationMintegral-8.1.4.0.zip" }
  s.platform            = :ios, '13.0'
  s.swift_version       = '5.0'
  s.static_framework    = true
  s.vendored_frameworks = 'CASMediationMintegral.xcframework'
  s.dependency 'MintegralAdSDK', '8.1.4'
  s.dependency 'MintegralAdSDK/BidSplashAd', '8.1.4'
