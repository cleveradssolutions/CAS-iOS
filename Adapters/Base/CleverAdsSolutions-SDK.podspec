Pod::Spec.new do |s|
  ...
  s.subspec 'Pangle' do |b|
    b.dependency 'CASMediationPangle', '7.9.1.1.0'
    b.dependency 'CleverAdsSolutions-Base', '4.6.5'
  end
  ...
  s.subspec 'Optimal' do |b|
    b.dependency 'CleverAdsSolutions-SDK/IronSource', '4.6.5'
    b.dependency 'CleverAdsSolutions-SDK/UnityAds', '4.6.5'
    b.dependency 'CleverAdsSolutions-SDK/GoogleAds', '4.6.5'
    b.dependency 'CleverAdsSolutions-SDK/LiftoffMonetize', '4.6.5'
    b.dependency 'CleverAdsSolutions-SDK/InMobi', '4.6.5'
    b.dependency 'CleverAdsSolutions-SDK/Chartboost', '4.6.5'
    b.dependency 'CleverAdsSolutions-SDK/Mintegral', '4.6.5'
    b.dependency 'CleverAdsSolutions-SDK/AppLovin', '4.6.5'
    b.dependency 'CleverAdsSolutions-SDK/Pangle', '4.6.5'
    b.dependency 'CleverAdsSolutions-SDK/Bigo', '4.6.5'
    b.dependency 'CleverAdsSolutions-SDK/YangoAds', '4.6.5'
    b.dependency 'CleverAdsSolutions-SDK/AudienceNetwork', '4.6.5'
    b.dependency 'CleverAdsSolutions-SDK/CASExchange', '4.6.5'
  end
  ...
  s.subspec 'Families' do |b|
    ...
    b.dependency 'CleverAdsSolutions-SDK/InMobi', '4.6.5'
    b.dependency 'CleverAdsSolutions-SDK/Chartboost', '4.6.5'
    b.dependency 'CleverAdsSolutions-SDK/Kidoz', '4.6.5'
    b.dependency 'CleverAdsSolutions-SDK/Mintegral', '4.6.5'
    b.dependency 'CleverAdsSolutions-SDK/YangoAds', '4.6.5'
  end
  ...
  s.subspec 'VPNCompliant' do |b|
    ...
    b.dependency 'CleverAdsSolutions-SDK/Bigo', '4.6.5'
    b.dependency 'CleverAdsSolutions-SDK/YangoAds', '4.6.5'
    b.dependency 'CleverAdsSolutions-SDK/YsoNetwork', '4.6.5'
  end
end
