Pod::Spec.new do |s|
  ...
  s.subspec 'IronSource' do |b|
    ...
    b.dependency 'CleverAdsSolutions-Base', '4.8.0'
  end
  ...
  s.subspec 'Optimal' do |b|
    b.dependency 'CleverAdsSolutions-SDK/IronSource', '4.8.0'
    b.dependency 'CleverAdsSolutions-SDK/UnityAds', '4.8.0'
    b.dependency 'CleverAdsSolutions-SDK/GoogleAds', '4.8.0'
    b.dependency 'CleverAdsSolutions-SDK/LiftoffMonetize', '4.8.0'
    b.dependency 'CleverAdsSolutions-SDK/InMobi', '4.8.0'
    b.dependency 'CleverAdsSolutions-SDK/Mintegral', '4.8.0'
    b.dependency 'CleverAdsSolutions-SDK/AppLovin', '4.8.0'
    b.dependency 'CleverAdsSolutions-SDK/Pangle', '4.8.0'
    b.dependency 'CleverAdsSolutions-SDK/Bigo', '4.8.0'
    b.dependency 'CleverAdsSolutions-SDK/YangoAds', '4.8.0'
    b.dependency 'CleverAdsSolutions-SDK/AudienceNetwork', '4.8.0'
    b.dependency 'CleverAdsSolutions-SDK/YsoNetwork', '4.8.0'
    b.dependency 'CleverAdsSolutions-SDK/CASExchange', '4.8.0'
    b.dependency 'CleverAdsSolutions-SDK/Maticoo', '4.8.0'
  end
  ...
  s.subspec 'Families' do |b|
    ...
    b.dependency 'CleverAdsSolutions-SDK/LiftoffMonetize', '4.8.0'
    b.dependency 'CleverAdsSolutions-SDK/InMobi', '4.8.0'
    b.dependency 'CleverAdsSolutions-SDK/Chartboost', '4.8.0'
    b.dependency 'CleverAdsSolutions-SDK/Kidoz', '4.8.0'
    b.dependency 'CleverAdsSolutions-SDK/Mintegral', '4.8.0'
    b.dependency 'CleverAdsSolutions-SDK/YangoAds', '4.8.0'
  end
  ...
  s.subspec 'VPNCompliant' do |b|
    ...
    b.dependency 'CleverAdsSolutions-SDK/YangoAds', '4.8.0'
    b.dependency 'CleverAdsSolutions-SDK/YsoNetwork', '4.8.0'
    b.dependency 'CleverAdsSolutions-SDK/MonetrixVPN', '4.8.0'
  end
  ...
  s.subspec 'Publishing' do |b|
    ...
    b.dependency 'CleverAdsSolutions-SDK/YsoNetwork', '4.8.0'
    b.dependency 'CleverAdsSolutions-SDK/CASExchange', '4.8.0'
    b.dependency 'CleverAdsSolutions-SDK/Ogury', '4.8.0'
    b.dependency 'CleverAdsSolutions-SDK/Maticoo', '4.8.0'
    b.dependency 'CleverAdsSolutions-SDK/Monetrix', '4.8.0'
    b.dependency 'CleverAdsSolutions-SDK/Moloco', '4.8.0'
  end
end
