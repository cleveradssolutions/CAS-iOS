Pod::Spec.new do |s|
  ...
  s.subspec 'Mintegral' do |b|
    b.dependency 'CASMediationMintegral', '8.1.3.0'
    b.dependency 'CleverAdsSolutions-Base', '4.7.1'
  end

  s.subspec 'AppLovin' do |b|
    b.dependency 'CASMediationAppLovin', '13.6.2.2'
    b.dependency 'CleverAdsSolutions-Base', '4.7.1'
  end

  s.subspec 'Pangle' do |b|
    b.dependency 'CASMediationPangle', '8.0.1.0.0'
    b.dependency 'CleverAdsSolutions-Base', '4.7.1'
  end
  ...
  s.subspec 'YangoAds' do |b|
    b.dependency 'CASMediationYangoAds', '8.0.0.0'
    b.dependency 'CleverAdsSolutions-Base', '4.7.1'
  end
  ...
  s.subspec 'Optimal' do |b|
    b.dependency 'CleverAdsSolutions-SDK/IronSource', '4.7.1'
    b.dependency 'CleverAdsSolutions-SDK/UnityAds', '4.7.1'
    b.dependency 'CleverAdsSolutions-SDK/GoogleAds', '4.7.1'
    b.dependency 'CleverAdsSolutions-SDK/LiftoffMonetize', '4.7.1'
    b.dependency 'CleverAdsSolutions-SDK/InMobi', '4.7.1'
    b.dependency 'CleverAdsSolutions-SDK/Mintegral', '4.7.1'
    b.dependency 'CleverAdsSolutions-SDK/AppLovin', '4.7.1'
    b.dependency 'CleverAdsSolutions-SDK/Pangle', '4.7.1'
    b.dependency 'CleverAdsSolutions-SDK/Bigo', '4.7.1'
    b.dependency 'CleverAdsSolutions-SDK/YangoAds', '4.7.1'
    b.dependency 'CleverAdsSolutions-SDK/AudienceNetwork', '4.7.1'
    b.dependency 'CleverAdsSolutions-SDK/YsoNetwork', '4.7.1'
    b.dependency 'CleverAdsSolutions-SDK/CASExchange', '4.7.1'
    b.dependency 'CleverAdsSolutions-SDK/Maticoo', '4.7.1'
  end
  ...
  s.subspec 'Families' do |b|
    ...
    b.dependency 'CleverAdsSolutions-SDK/LiftoffMonetize', '4.7.1'
    b.dependency 'CleverAdsSolutions-SDK/InMobi', '4.7.1'
    b.dependency 'CleverAdsSolutions-SDK/Chartboost', '4.7.1'
    b.dependency 'CleverAdsSolutions-SDK/Kidoz', '4.7.1'
    b.dependency 'CleverAdsSolutions-SDK/Mintegral', '4.7.1'
    b.dependency 'CleverAdsSolutions-SDK/YangoAds', '4.7.1'
  end
