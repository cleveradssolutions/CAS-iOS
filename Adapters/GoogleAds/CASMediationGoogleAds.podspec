Pod::Spec.new do |s|
  ...
  s.source              = { :http => "https://github.com/cleveradssolutions/CAS-iOS/releases/download/4.6.3/CASMediationGoogleAds-13.1.0.0.zip" }
  s.platform            = :ios, '13.0'
  s.swift_version       = '5.0'
  s.static_framework    = true
  s.vendored_frameworks = 'CASMediationGoogleAds.xcframework'
  s.dependency 'Google-Mobile-Ads-SDK', '13.1.0'
