...
```ruby
pod 'CASMediationUnityAds', '4.18.0.0'
```

### 4.18.0.0
- Certified with UnityAds - 4.18.0

### 4.17.0.0
- Certified with UnityAds - 4.17.0
- Reduced memory usage during network requests.

### 4.16.6.0
- Certified with UnityAds - 4.16.6
...
### 4.16.1.0
- Certified with UnityAds - 4.16.1
