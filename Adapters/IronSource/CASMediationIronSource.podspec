Pod::Spec.new do |s|
  ...
  s.source              = { :http => "https://github.com/cleveradssolutions/CAS-iOS/releases/download/4.7.0-alpha1/CASMediationIronSource-9.4.0.1.zip" }
  s.platform            = :ios, '13.0'
  s.swift_version       = '5.0'
  s.static_framework    = true
  s.vendored_frameworks = 'CASMediationIronSource.xcframework'
  s.dependency 'IronSourceSDK', '9.4.0'
